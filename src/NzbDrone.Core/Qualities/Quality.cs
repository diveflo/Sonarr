...
namespace NzbDrone.Core.Qualities
{
    public class Quality : IEmbeddedDocument, IEquatable<Quality>
    {
        ...
        public static Quality Bluray1080pRemux => new Quality(99, "Bluray-1080p Remux", QualitySource.BlurayRaw, 1080);
        ...
        static Quality()
        {
            ...
            DefaultQualityDefinitions = new HashSet<QualityDefinition>
            {
                ...
                new QualityDefinition(Quality.WEBRip720p)       { Weight = 8,  MinSize = 0, MaxSize = 130,  GroupName = "WEB 720p" },
                new QualityDefinition(Quality.WEBDL720p)        { Weight = 8,  MinSize = 0, MaxSize = 130,  GroupName = "WEB 720p" },
        ...
        {
            var qualityMaybeHEVC = All.Where(q => q.Source == source && q.Resolution == resolution).ToList();
