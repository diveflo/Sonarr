...
namespace NzbDrone.Core.Parser
{
    public class QualityParser
    {
        ...
        private static readonly Regex SourceRegex = new Regex(@"\b(?:
                                                                ...
                                                                (?<webdl>WEB[-_. ]DL|WEBDL|AmazonHD|iTunesHD|MaxdomeHD|NetflixU?HD|WebHD|[. ]WEB[. ](?:[xh]26[45]|DDP?5[. ]1)|[. ](?-i:WEB)$|\d+0p(?:[-. ]AMZN)?[-. ]WEB[-. ]|WEB-DLMux|\b\s\/\sWEB\s\/\s\b|AMZN[. ]WEB[. ]|HashMiner)|NF[. ]WEB[. ])|
